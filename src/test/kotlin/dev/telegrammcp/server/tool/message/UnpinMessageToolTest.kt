...
class UnpinMessageToolTest {
    ...
    private lateinit var tool: UnpinMessageTool
    ...
    fun `definition returns correct tool name`() {
        assertEquals("unpin_message", tool.definition().name())
    }

    @Test
    fun `unpins message successfully`() {
