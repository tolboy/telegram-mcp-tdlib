...
class PinMessageToolTest {
    ...
    private lateinit var tool: PinMessageTool
    ...
    fun `definition returns correct tool name`() {
        assertEquals("pin_message", tool.definition().name())
    }

    @Test
    fun `pins message successfully`() {
