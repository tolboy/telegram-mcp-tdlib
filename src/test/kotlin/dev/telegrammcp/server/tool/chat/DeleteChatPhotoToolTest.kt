...
class DeleteChatPhotoToolTest {
    ...
    private lateinit var tool: DeleteChatPhotoTool
    ...
    fun `definition returns correct tool name`() {
        assertEquals("delete_chat_photo", tool.definition().name())
    }

    @Test
    fun `deletes chat photo successfully`() {
        ...
        verify { operationGuardService.checkPermission("delete_chat_photo", any()) }
    }
