...
class UnarchiveChatToolTest {
    ...
    private lateinit var tool: UnarchiveChatTool
    ...
    fun `definition returns correct tool name`() {
        assertEquals("unarchive_chat", tool.definition().name())
    }

    @Test
    fun `unarchives chat successfully`() {
        every { entityResolver.resolve(42 as Any) } returns 42L
        every { telegramClient.unarchiveChat(42L) } returns true
