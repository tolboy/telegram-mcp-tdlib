...
class SetChatDescriptionToolTest {
    ...
    private lateinit var tool: SetChatDescriptionTool
    ...
    fun `definition returns correct tool name`() {
        assertEquals("set_chat_description", tool.definition().name())
    }

    @Test
    fun `sets chat description`() {
    ...
    @Test
    fun `clears description with empty string`() {
        every { entityResolver.resolve(42 as Any) } returns 42L
