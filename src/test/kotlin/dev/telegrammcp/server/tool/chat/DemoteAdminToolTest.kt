...
class DemoteAdminToolTest {
    ...
    private lateinit var tool: DemoteAdminTool
    ...
    fun `definition returns correct tool name`() {
        assertEquals("demote_admin", tool.definition().name())
    }

    @Test
    fun `demotes admin successfully`() {
