...
class BlockUserToolTest {
    ...
    fun `definition returns correct tool name`() {
        assertEquals("block_user", tool.definition().name())
    }
    ...
    fun `blocks user successfully`() {
        ...
        verify { operationGuardService.checkPermission("block_user", any()) }
    }
